    ...
    return(
        <div>
            <Navbar />
                ...
                <div className='container'>
                    <div className='prozess-headline'>
                        <h1>Einfacher Ablauf:</h1>
                    </div>
                    <div className='prozess-section'>
                        <div className='sidebar'>
                        </div>
                        <div className='circle-1'>
                            <FontAwesomeIcon icon={faCamera} className="o-icon" />
                        </div>
                        <div className='step1'>
                        ...
                        <div className='circle-2'>
                            <FontAwesomeIcon icon={faPencil} className='o-icon' />
                        </div>
                        <div className='step2'>
                        ...
                        <div className='circle-3'>
                            <FontAwesomeIcon icon={faPrint} className="o-icon" />
                        </div>
                        <div className='step3'>
                        ...
                        <div className='circle-4'>
                            <FontAwesomeIcon icon={faTruckFast} className="o-icon" />
                        </div>
                        <div className='step4'>
