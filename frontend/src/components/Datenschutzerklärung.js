...
function Datenschutzerklärung() {
    ...
    <>
        ...
        <div className="datenschutzsection">
            <div className="datenschutz-content">
                <div className="datenschutz-titel">
                    <h1>Datenschutzerklärung</h1>
                </div>
                <div className="datenschutz-text">
                    <h2>Verantwortlicher im Sinne der Datenschutz-Grundverordnung (DSGVO) und anderer nationaler Datenschutzgesetze der Mitgliedstaaten sowie sonstiger datenschutzrechtlicher Bestimmungen ist:</h2>
                    <p>
                        [Name des Unternehmens/der Organisation]
                    <br/>
                        [Adresse des Unternehmens/der Organisation]
                    <br/>
                        [Telefonnummer des Unternehmens/der Organisation]
                    <br/>
                        [E-Mail-Adresse des Unternehmens/der Organisation]
                    </p>
                    <h2>1. Erfassung und Verarbeitung von personenbezogenen Daten</h2>
                    <p>
                    ...
                    <h2>2. Rechtsgrundlage für die Verarbeitung personenbezogener Daten</h2>
                    <p>
