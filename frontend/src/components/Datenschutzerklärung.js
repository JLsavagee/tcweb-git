        ...
        <div className="datenschutzsection">
            <div className="datenschutz-content">
                ...
                <div className="datenschutz-text">
                    <h3>Verantwortlicher im Sinne der Datenschutz-Grundverordnung (DSGVO) und anderer nationaler Datenschutzgesetze der Mitgliedstaaten sowie sonstiger datenschutzrechtlicher Bestimmungen ist:</h3>
                    <p>
